...
void Logger(int operation, const char *accNum, const char *date, float newBalance, float balance) {
    ...
    switch (operation) {
        case 1: {
            // Account Creation
            fprintf(logFile, "Account Creation - Account Number: %s, Date: %s, Account Balance: %.2f\n", accNum, date, newBalance);
            break;
        }
        case 2: {
            // Account Deletion
            fprintf(logFile, "Account Deletion - Account Number: %s, Date: %s\n", accNum, date);
            break;
        }

        case 3: {
            // Account Withdrawal
            fprintf(logFile, "Account Withdrawal - Account Number: %s, Date: %s, Withdraw Amount: %.2f, New Balance: %.2f\n", accNum, date, balance, newBalance);
            break;
        }

        case 4: {
            // Account Deposit
            fprintf(logFile, "Account Deposit - Account Number: %s, Date: %s, Deposit Amount: %.2f, New Balance: %.2f\n", accNum, date, balance, newBalance);
            break;
        }

        case 5: {
            // Account Update Pin
            fprintf(logFile, "Account Update Pin - Account Number: %s, Date: %s\n", accNum, date);
            break;
        }
    }
